...
public class ChekcinController implements Initializable {
    ...
    public void Customercheckin() {
        ...
        try {
            ...
            if (customerNum == null || type == null || number == null || firstN == null ||
                    Lastname == null || PNumber == null || mail == null ) {
            ...
            }else if (Checkin_Date.getValue().isAfter(CheckOut_Date.getValue())){

                Alert alert1 = new Alert(Alert.AlertType.ERROR);
                alert1.setTitle("Error Message");
                alert1.setHeaderText(null);
                alert1.setContentText("Invalid CheckOut Date!");
                alert1.showAndWait();
